...
public class GameString {
    ...
    public static String x2XPSuccess() {
        return "Sử dụng thành công. Bạn có 1 ngày xp x6!.";
    }
    ...
    public static String newsNoti() {
        return "Chào mừng %s đến với Cộng Đồng Army Lậu - TNTGAME.";
    }
    
            public static String newsBaoTri() {
        return "Bảo Trì: Server tự động bảo trì vào khung giờ chuẩn: 1h 2h 3h 4h ... các bạn sắp sếp thời gian chơi hợp lí nhé!";
    }
        ...
        return "Thay thế nút nạp tiền thành lưu dữ liệu. Mọi người chơi xong nhớ ấn vào nút đó để lưu data !";
    }
    ...
    public static String userLoginActive() {
        return "Gửi tin nhắn: ON KHTNT %s gửi 8285 để kích hoạt bạn nhé. ";
    }
