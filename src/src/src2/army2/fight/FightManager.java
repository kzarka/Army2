    ...
    private void nextBoss() throws IOException {
        ...
        if(this.wait.map == 30) {
            ...
            for(int i = 0; i < numBoss; i++) {
                short X = (short)((i%2 == 0)? Until.nextInt(100, 200):Until.nextInt(950, 1000));
                short Y = (short)(50+40*Until.nextInt(3));
                players[allCount] = new SmallBoom(this, (byte)12, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
        ...
        if(this.wait.map == 31) {
            ...
            for(int i = 0; i < numBoss; i++) {
                short X = (short)((i%2 == 0)? Until.nextInt(437, 525):Until.nextInt(950, 1000));
                short Y = (short)(50+40*Until.nextInt(3));
                players[allCount] = new SmallBoom(this, (byte)12, "BOSS", (byte)allCount, 5000, X, Y);
                allCount++;
        ...
        if(this.wait.map == 34) {
            short X = (short)(880);
            short Y = (short)(400);
            players[allCount] = new TRex(this, (byte)15, "T-Rex", (byte)allCount, 10000000, X, Y);
            allCount++;
    ...
    private void fightComplete(int checkWin) throws IOException {
        ...
        for(int i = 0; i < ServerManager.maxPlayers; i++) {
            ...
            int abc = rd.nextInt(4);
            {
               if(abc == 2)
               {
                   int abcd = rd.nextInt(15);
                   short itemhopqua = 1;
                    if(abcd == 0) itemhopqua = 88;
                    if(abcd == 3) itemhopqua = 102;
                    if(abcd == 5) itemhopqua = 103;
                    if(abcd == 7) itemhopqua = 88;
                    if(abcd == 9) itemhopqua = 103;
                    if(abcd == 11) itemhopqua = 88;
                   pl.us.AddItemE(itemhopqua);
                   ms = new Message(10);
                   ds = ms.writer();
                   ds.writeUTF(GameString.giftWin());
               }
            }
            int abcq = Until.nextInt(2);
            if(abcq == 0){
