...
public void addShootBoss(Player pl, byte bull, short angle, byte force, byte force2, byte nshoot, short Xboss, short Yboss) {
        this.XPL = pl.X;
        this.YPL = pl.Y;
        this.arg = angle;
        this.force2 = force2;
        ...
        x  = pl.X+(20*Until.cos(angle)>>10); ServerManager.log("X: " + x);
        y  = pl.Y-12-(20*Until.sin(angle)>>10); ServerManager.log("Y: " + y);
        vx =  (force * Until.cos(angle) >> 10); ServerManager.log("VX: " + vx);
        vy = -(force * Until.sin(angle) >> 10); ServerManager.log("VY: " + vy);
        ...
        for(int k = 0; k < nshoot; k++) {
            ...
            // T-Rex tha boom
            case 0:
                entrys.add(new TrexThaBoom(this, (byte)4, 50000, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;
            }
        }
        */
        ...
        for(int k = 0; k < nshoot; k++) {
           ...
           /* case 0:
            ...
            case 0: 
                if ((pl.itemUsed >= 0) || (idGun != 0))
            return;
               entrys.add(new Bullet(this, (byte)0, (pl.isUsePow ? 3300 : (nshoot == 2 ? 210:1700)), pl, x, y, vx, vy, 80, 100));
        break;
            ...
            case 1:
                ...
                for(int i = 0; i < nBull; i++)
                   entrys.add(new Bullet(this, (byte)1, nshoot==2? 109:650, pl, x, y, vx, vy, 50, 50));
                break;
            ...
            case 2:
                ...
                for(int i=0; i<nBulls; i++) {
                    ...
                    entrys.add(new Bullet(this, (byte)2, nshoot==2? 75:550, pl, x, y, vx, vy, 80, 60));
                    if(i == 0)
                        continue;
                    arg = angle-i*5;
                    x  = pl.X+(20*Until.cos(arg)>>10);
            ...
            case 4:
                ...
                entrys.add(new ItemBomB52(this, (byte)4, 60, pl, x, y, vx, vy, 0, 80));
                break;
            ...
            case 9:
                ...
                for(int i=0; i<4; i++, arg2+=4) {
                    ...
                    entrys.add(new Bullet(this, (byte)9, pl.isUsePow? 1000:(nshoot==2? 79:500), pl, x, y, vx, vy, 40, 90));
                }
                break;
            ...
            case 10:
                if(pl.itemUsed >= 0 || idGun != 4)
                    return;
                for(int i = 0; i < 3; i++)
                    entrys.add(new Bullet(this, (byte)10, pl.isUsePow? 1000:(nshoot==2? 80:470), pl, x, y, vx, vy, 50, 80));
                break;
            ...
            case 11:
                if(pl.itemUsed >= 0 || idGun != 5)
                    return;
                for(int i = 0; i < 5; i++)
                    entrys.add(new Bullet(this, (byte)11, pl.isUsePow? 760:(nshoot==2? 47:350), pl, x, y, vx, vy, 30, 90));
                break;
            ...
            case 14:
                if(pl.itemUsed != 16)
                    return;
                entrys.add(new ItemLaser(this, (byte)14, 50, pl, x, y, vx, vy, 10, 50));
                break;
            ...
            case 17:
                if(pl.itemUsed >= 0 || idGun != 8)
                    return;
                entrys.add(new ApaBullet(this, (byte)17, pl.isUsePow? 850:(nshoot==2? 81:390), pl, x, y, vx, vy, 30, 100, force, force2));
                break;
            ...
            case 19:
                if(pl.itemUsed >= 0 || idGun != 6)
                    return;
                entrys.add(new ChickyBullet(this, (byte)19, pl.isUsePow? 2300:(nshoot==2? 169:1300), pl, x, y, vx, vy, 20, 50, force2));
                break;
            ...
            case 21:
                if(pl.itemUsed >= 0 || idGun != 7)
                    return;
                entrys.add(new TazranBullet(this, (byte)21, pl.isUsePow? 3700: (nshoot==2? 225:2000), pl, x, y, vx, vy, 10, 50));
                break;
            ...
            case 31:
                if(idGun != 12)
                    return;
                entrys.add(new BigBoomBum(this, (byte)31, 10000, pl));
                break;
            ...
            case 32:
                if(idGun != 11)
                    return;
                entrys.add(new SmallBoomBum(this, (byte)32, 10000, pl));
                break;
           //
            case 35:
                if (idGun != 15)
                    return;
                entrys.add(new TRexNhay(this, (byte)35, 200, pl));
                break;
            ...
            case 37:
                if (idGun != 15)
                    return;
                entrys.add(new TrexThaBoom(this, (byte)37, 1000000, pl));
                break;
               //
            case 40:
                if (idGun != 15)
                    return;
                entrys.add(new TrexThaBoom(this, (byte)40, 1000000, pl));
                break;
                 //
            case 41:
                if (idGun != 15)
                    return;
                entrys.add(new TrexThaBoom(this, (byte)41, 1000000, pl));
                break;
                ///id 35,36,37 là của ăns
            ...
            case 49:
                ...
                if(ServerManager.mgtBullNew)
                    entrys.add(new MGTBulletNew(this, (byte)49, pl.isUsePow? 3000: (nshoot==2? 308:1500), pl, x, y, vx, vy, 40, 70));
                else {
                    vx =  (1600 * Until.cos(angle) >> 10);
                    vy = -(1600 * Until.sin(angle) >> 10);
                    entrys.add(new MGTBulletOld(this, (byte)59, pl.isUsePow? 3200: (nshoot==2? 308:1600), pl, x, y, vx, vy, force));
                }
                break;
