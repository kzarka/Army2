...
public class Player {
    ...
    public Player(FightManager fightMNG, byte location, short X, short Y, int item[], int teamPoint, User us) throws IOException {
        ...
        if(this.phongThu >= 2500) this.phongThu = 2000 + teamPoint / 10;
        //this.phongThu  = 0;
        this.mayMan    = ability[3]+teamPoint*2;
        this.HP        = this.HPMax;
 ...
 public final void addGiftPlayer(int id, int numb) throws IOException {
        if(us == null)
            return;
        us. addGift(id, numb);
    ...
    public void collision(short bx, short by, Bullet bull) {
        ...
        System.out.println("bullId "+bull.bullId+" "+this.idNV ); 
        if (bull.bullId==35){
        if (this.idNV<11){
        dame = 100000;
        }
            ...
            if(this.isDie) {
                ...
                try {
                    ...
                    if(this instanceof Boss) {
                        if(idNV == 11)
                            bull.pl.updateEXP(30000);
                             bull.pl.addGiftPlayer(90, 100);
                             bull.pl.addGiftPlayer(100, 100);                                                    
                        if(idNV == 12)
                            bull.pl.updateEXP(50000);
                             bull.pl.addGiftPlayer(90, 100);
                             bull.pl.addGiftPlayer(100, 100);                       
                         bull.pl.updateCUP(+50);
                        ...
                        if(idNV == 13)
                            bull.pl.updateEXP(20000);
                             bull.pl.addGiftPlayer(90, 10);                       
                        if(idNV == 14)
                            bull.pl.updateEXP(20000);
                            bull.pl.addGiftPlayer(90, 10);                        
                        if(idNV == 15)
                            bull.pl.updateEXP(200000);
                             bull.pl.addGiftPlayer(90, 10);
                        if(idNV == 16)
                            bull.pl.updateEXP(20000);
                             bull.pl.addGiftPlayer(90, 1);                       
                        if(idNV == 17)
                            bull.pl.updateEXP(20000);
                             bull.pl.addGiftPlayer(90, 1);                       
                        if(idNV == 18)
