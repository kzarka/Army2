 ...
 * @author ASD
 */
public class HangNhen extends Boss {
    
    public boolean isExists;

    public HangNhen(FightManager fightMNG, byte idGun, String name, byte location, int HPMax, short X, short Y) throws IOException {
    ...
    public void turnAction() {
        ...
        try {
            ...
            if(Math.abs(X - pl.X) >= 1)
                this.fightMNG.newShootBoss(this.index, (byte)5, (short)105, (byte)30, (byte)0, (byte)1, false, pl.X, this.Y);
            else
