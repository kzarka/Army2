...
import army2.fight.boss.BackFan;
...
import army2.fight.boss.Box;
import army2.fight.boss.Eye;
import army2.fight.boss.GunBig;
import army2.fight.boss.SmallBoom;
import army2.fight.boss.TRex;
import army2.fight.boss.MapNhen;
import army2.fight.boss.TPMay;
import army2.fight.boss.KVCam;
import army2.fight.boss.HiMaLapSon;
import army2.fight.boss.HangNhen;
import army2.fight.boss.KhiCau;
import army2.fight.boss.MainGun;
import army2.fight.boss.NT1;
import army2.fight.boss.NT2;
import java.util.Random;
import army2.server.User.ruongDoTBEntry;
/**
 *
 * @author ASD
 */
    ...
    private void nextBoss() throws IOException {
        ...
        if(this.wait.map == 30) {
            ...
            for(int i = 0; i < numBoss; i++) {
                ...
                players[allCount] = new BigBoom(this, (byte)12, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
            }
        }
        //map boom2
        if(this.wait.map == 31) {
            int numBoss = (new int[]{4, 4, 5, 5, 6, 8, 8, 9, 9})[playerCount];
            for(int i = 0; i < numBoss; i++) {
                short X = (short)((i%2 == 0)? Until.nextInt(437, 525):Until.nextInt(950, 1000));
                short Y = (short)(50+40*Until.nextInt(3));
                players[allCount] = new BigBoom(this, (byte)12, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
            ...
            for(int i = 0; i < numBoss; i++) {
                short X = (short)((i%2 == 0)? Until.nextInt(437, 525):Until.nextInt(950, 1000));
                short Y = (short)(50+40*Until.nextInt(3));
                players[allCount] = new SmallBoom(this, (byte)11, "BOSS", (byte)allCount, 5000, X, Y);
                allCount++;
        ...
        //map nhen
            ...
            for(int i = 0; i < numBoss; i++) {
                short X = (short)((i%2 == 0)? Until.nextInt(100, 200):Until.nextInt(950, 1000));
                short Y = (short)(50+40*Until.nextInt(3));
                players[allCount] = new MapNhen(this, (byte)13, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
            }
        }
                        //map thanh pho may
            if(this.wait.map == 33) {
            int numBoss = (new int[]{1, 1, 1, 1, 1, 1, 1, 1, 1})[playerCount];
            for(int i = 0; i < numBoss; i++) {
                short X = (short)880;
                short Y = (short)50;
                players[allCount] = new TPMay(this, (byte)14, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
            }
        }
        ...
        if(this.wait.map == 34) {
            short X = (short)(880);
            short Y = (short)(50);
            players[allCount] = new TRex(this, (byte)15, "T-Rex", (byte)allCount, 777777, X, Y);
            allCount++;
            int numBoss = new int[] {4, 4, 3, 3, 4, 4, 5, 6, 6}[playerCount];
            for(int i = 0; i < numBoss; i++) {
                X = (short) (Until.nextInt(600, 700));
                Y = (short) (50+40*Until.nextInt(3));
                players[allCount] = new BigBoom(this, (byte)12, "BOSS", (byte)allCount, 5000, X, Y);
                allCount++; }
                //random tọa độ hộp quà Từ Ngọc Trai
            int nextInt = Until.nextInt(300,500);
                players[allCount] = new Box(this, (byte)23, "BOSS", (byte)allCount, 100, (short) (nextInt), (short) (50*Until.nextInt(3)));
                allCount++;
        ...
        //KV cam
            ...
            for(int i = 0; i < numBoss; i++) {
                short X = 550;
                short Y = 100;
                players[allCount] = new KVCam(this, (byte)16, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
                players[allCount] = new KVCam(this, (byte)24, "BOSS", (byte)allCount, 20000, (short) (X - 45), (short) (Y));
                allCount++;
            ...
            if(this.wait.map == 36) {
                short X = 550;
                short Y = 20;
                players[allCount] = new KhiCau(this, (byte)17, "BOSS", (byte)allCount, 100000, X, Y);
                allCount++;
                players[allCount] = new MainGun(this, (byte)18, "BOSS", (byte)allCount, 20000, (short) (X + 45), (short) (Y + 15));
                allCount++;
                players[allCount] = new GunBig(this, (byte)19, "BOSS", (byte)allCount, 20000, (short) X, (short) (Y + 20));
                allCount++;
                players[allCount] = new BackFan(this, (byte)20, "BOSS", (byte)allCount, 20000, (short) (X - 40), (short) Y);
                allCount++;
                players[allCount] = new Eye(this, (byte)21, "BOSS", (byte)allCount, 20000, (short) (X + 45), (short) (Y - 10));
                allCount++;
            ...
            for(int i = 0; i < numBoss; i++) {
                short X = 750;
                short Y = 110;
                players[allCount] = new HangNhen(this, (byte)22, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
            }
        }              
            ...
            int numBoss = (new int[]{4, 4, 5, 5, 6, 8, 8, 9, 9})[playerCount];
            for(int i = 0; i < numBoss; i++) {
                short X = (short)((i%2 == 0)? Until.nextInt(67, 345):Until.nextInt(236, 276));
                short Y = (short)(50+40*Until.nextInt(3));
                players[allCount] = new NT1(this, (byte)19, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
            }
        }             
            ...
            int numBoss = (new int[]{4, 4, 5, 5, 6, 8, 8, 9, 9})[playerCount];
            for(int i = 0; i < numBoss; i++) {
                short X = (short)((i%2 == 0)? Until.nextInt(572, 448):Until.nextInt(113, 128));
                short Y = (short)(50+40*Until.nextInt(3));
                players[allCount] = new NT2(this, (byte)20, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
            }
        }        
...
*/
    ...
    private void fightComplete(int checkWin) throws IOException {
        ...
        for(int i = 0; i < ServerManager.maxPlayers; i++) {
            ...
            int abc = rd.nextInt(4);
            {
               if(abc == 2)
               {
                   int abcd = rd.nextInt(8);
                   short itemhopqua = 95;
                    if(abcd == 0) itemhopqua = 91;
                    if(abcd == 1) itemhopqua = 92;                   
                    if(abcd == 2) itemhopqua = 99;
                    if(abcd == 3) itemhopqua = 94;
                    if(abcd == 5) itemhopqua = 95;
                    if(abcd == 6) itemhopqua = 96;
                    if(abcd == 7) itemhopqua = 97;
		    int numb = Until.nextInt(5, 11);
                   pl.us.AddItemE(itemhopqua, numb);
               }
            }
            pl.us.AddItemE((short)99);
    ...
    protected void startGame(int nTeamPointBlue, int nTeamPointRed) throws IOException {
        ...
        if(this.ltap) {
            ...
            for(int i = 0; i < this.wait.maxPlayer; i++) {
                ...
                /*int tangquaeve = rd.nextInt(5);
                if(tangquaeve == 2)
                {
                    us.updateItem((byte)94,1);
                }*/
...
public void newShootBoss(int index, byte bullId, short arg, byte force, byte force2, byte nshoot, boolean ltap, short Xboss, short Yboss) throws IOException {
        //ServerManager.log("New shoot index="+index+" bullId: "+bullId+" arg: "+arg+" force: "+force+" force2: "+force2+" nshoot: "+nshoot);
        final Player pl = this.players[index];
        short x = pl.X, y = pl.Y;
        if(!ltap)
            this.calcMM();
        bullMNG.addShootBoss(pl, bullId, arg, force, force2, nshoot, Xboss, Yboss);
        bullMNG.fillXY();
        if(!this.ltap)
            this.nextMM();
        ArrayList<Bullet> bullets = bullMNG.entrys;
    ...
    public void addGift(int id, int X, int Y) throws IOException {
        Message ms = new Message(-17); DataOutputStream ds = ms.writer();
        ds.writeByte(0);
        ds.writeByte(id);
        ds.writeInt(X);
        ds.writeInt(Y);
    ...
    public void exploreGift(int id, int X, int Y, Bullet bull) throws IOException {
        this.mapMNG.collision((short)X, (short)Y, bull);
        Message ms = new Message(-17); DataOutputStream ds = ms.writer();
        ds.writeByte(1);
        ds.writeByte(id);
    ...
    public void addGifts(int id, int X, int Y) throws IOException {
        Message ms = new Message(119); DataOutputStream ds = ms.writer();
        ds.writeByte(0);
        ds.writeByte(id);
        ds.writeInt(X);
        ds.writeInt(Y);
    ...
    public void exploreGifts(int id, int X, int Y, Bullet bull) throws IOException {
        this.mapMNG.collision((short)X, (short)Y, bull);
        Message ms = new Message(119); DataOutputStream ds = ms.writer();
        ds.writeByte(1);
        ds.writeByte(id);
    ...
    public void TRexSaid(Player pl) throws IOException {
        Message ms = new Message(9); DataOutputStream ds = ms.writer();
        ds.writeInt(0);
        ds.writeUTF("TRex: Cẩn thận tên lửa của tao!");
        ds.flush();
        this.sendToTeam(ms);
    }    
