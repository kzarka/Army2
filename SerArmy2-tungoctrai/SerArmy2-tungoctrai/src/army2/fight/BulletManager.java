...
import army2.fight.bullet.BulletBoss;
import army2.fight.bullet.DragonBullet;
import army2.fight.bullet.FireUFO;
...
public void addShootBoss(Player pl, byte bull, short angle, byte force, byte force2, byte nshoot, short Xboss, short Yboss) {
        ...
        for(int k = 0; k < nshoot; k++) {
            ...
            // T-Rex tha boom
                ...
                //47 axit
            case 0:
                entrys.add(new TrexThaBoom(this, (byte)40, 50, pl, x, y, vx, vy, 0, 50, Xboss, Yboss));
                break;
                case 1:
                entrys.add(new TRexNhay(this, (byte)35, 50, pl, x, y, vx, vy, 0, 10, Xboss, Yboss));
                break;
                case 2:
                entrys.add(new TrexThaBoom(this, (byte)37, 50, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;
                case 3:
                entrys.add(new TrexThaBoom(this, (byte)34, 1000, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;    
                                    case 4:
                entrys.add(new FireUFO(this, (byte)14, 1000, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;   
                                                                            case 5:
                entrys.add(new TrexThaBoom(this, (byte)47, 1000, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;   
                                                                                         case 6:
                entrys.add(new BulletBoss(this, (byte)36, 1000, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;         
                    /*                                                                                                                                                                  case 7:
                entrys.add(new BulletBoss(this, (byte)36, 1000, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;        */        
        ...
        for(int k = 0; k < nshoot; k++) {
           ...
           /* case 0:
            ...
            // Gunner -> dragon
                ...
                // 41 khoi trang 43 tha boom hmls 45 ta lazeyy
            case 0: 
                if ((pl.itemUsed >= 0) || (idGun != 0))
            return;
                int nBullDragon = pl.isUsePow ? 5:3;
                for(int i = 0; i < nBullDragon; i++)
                entrys.add(new DragonBullet(this, (byte)52, 500, pl, x, y, vx, vy, 80, 100));
        break;
            ...
            case 1:
                ...
                for(int i = 0; i < nBull; i++)
                    entrys.add(new Bullet(this, (byte)1, nshoot==2? 150:200, pl, x, y, vx, vy, 50, 50));
                break;
            ...
            case 17:
                if(pl.itemUsed >= 0 || idGun != 8)
                    return;
                entrys.add(new ApaBullet(this, (byte)17, pl.isUsePow? 216:(nshoot==2? 81:108), pl, x, y, vx, vy, 30, 50, force, force2));
                break;
            ...
            case 19:
                if(pl.itemUsed >= 0 || idGun != 6)
                    return;
                entrys.add(new ChickyBullet(this, (byte)19, pl.isUsePow? 650: (nshoot==2? 169:225), pl, x, y, vx, vy, 20, 50, force2));
                break;
            ...
            case 21:
                if(pl.itemUsed >= 0 || idGun != 7)
                    return;
                entrys.add(new TazranBullet(this, (byte)21, pl.isUsePow? 800: (nshoot==2? 225:330), pl, x, y, vx, vy, 10, 50));
                break;
            ...
            case 32:
                if(idGun != 11)
                    return;
                entrys.add(new SmallBoomBum(this, (byte)32, 1000, pl));
                break;
                //34 dan sinh boom
/*            case 35:
                if (idGun != 15)
                    return;
                entrys.add(new TRexNhay(this, (byte)37, 1000, pl));
                break;               
...
*/
            ...
            case 49:
                ...
                if(ServerManager.mgtBullNew)
                    ...
                    entrys.add(new MGTBulletOld(this, (byte)44, pl.isUsePow? 1000: (nshoot==2? 308:400), pl, x, y, vx, vy, force));
                }
                break;
