 ...
 * @author ASD
 */
public class MapNhen extends Boss {
    
    public boolean isExists;

    public MapNhen(FightManager fightMNG, byte idGun, String name, byte location, int HPMax, short X, short Y) throws IOException {
    ...
    public void turnAction() {
        ...
        try {
         ...
         this.fightMNG.newShootBoss(this.index, (byte)3, (short)105, (byte)30, (byte)0, (byte)1, false, pl.X, this.Y);
        } catch(Exception e) {
            e.printStackTrace();
        }
    }
