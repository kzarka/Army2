...
public void addShootBoss(Player pl, byte bull, short angle, byte force, byte force2, byte nshoot, short Xboss, short Yboss) {
        ...
        for(int k = 0; k < nshoot; k++) {
            ...
            // T-Rex tha boom
            case 0:
                entrys.add(new TrexThaBoom(this, (byte)37, 5000, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;
                case 1:
                entrys.add(new TrexThaBoom(this, (byte)36, 2000, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;
                case 2:
                entrys.add(new TrexThaBoom(this, (byte)22, 3500, pl, x, y, vx, vy, 0, 80, Xboss, Yboss));
                break;
            }
        }
    }
        ...
        break;
            ...
            case 19:
                if(pl.itemUsed >= 0 || idGun != 6)
                    return;
                entrys.add(new ChickyBullet(this, (byte)19, pl.isUsePow? 800: (nshoot==2? 169:225), pl, x, y, vx, vy, 20, 50, force2));
                break;
            ...
            case 31:
                if(idGun != 12)
                    return;
                entrys.add(new BigBoomBum(this, (byte)31, 4500, pl));
                break;
            ...
            case 32:
                if(idGun != 11)
                    return;
                entrys.add(new BigBoomBum(this, (byte)32, 3500, pl));
                break;
