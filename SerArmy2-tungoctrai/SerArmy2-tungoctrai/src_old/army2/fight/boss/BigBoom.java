...
public class BigBoom extends Boss {
    ...
    public BigBoom(FightManager fightMNG, byte idGun, String name, byte location, int HPMax, short X, short Y) throws IOException {
    ...
    public void turnAction() {
        ...
        try {
            ...
            //TOA DO X Y DUOI 30 => TRUE
            if(Math.abs(X - pl.X) <= 30)
           // if(Math.abs(Y - pl.Y) <= 30)
