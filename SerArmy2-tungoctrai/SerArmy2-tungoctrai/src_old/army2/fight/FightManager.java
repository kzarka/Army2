...
public class FightManager {
    ...
    public void sendToTeam2(Message ms) throws IOException {
        if(this.ltap) {
            this.userLt.sendMessage(ms);
            return;
        }
    ...
    private void nextBoss() throws IOException {
        ...
        if(this.wait.map == 34) {
            short X = (short)(880);
            short Y = (short)(50);
            players[allCount] = new TRex(this, (byte)15, "T-Rex", (byte)allCount, 999999, X, Y);
            allCount++;
            int numBoss = new int[] {4, 4, 3, 3, 4, 4, 5, 6, 6}[playerCount];
            for(int i = 0; i < numBoss; i++) {
                X = (short) (Until.nextInt(515, 700));
                Y = (short) (50+40*Until.nextInt(3));
                players[allCount] = new BigBoom(this, (byte)12, "BOSS", (byte)allCount, 10000, X, Y);
                allCount++;
            }
            /*for(int i = 0; i < numBoss; i++) {
                X = (short) (Until.nextInt(100, 200));
                Y = (short) (50+40*Until.nextInt(3));
                players[allCount] = new BigBoom(this, (byte)11, "BOSS", (byte)allCount, 5000, X, Y);
                allCount++;
            }*/
        }
