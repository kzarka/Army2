...
public class GameString {
    ...
    public static String loiChuc() {
        return "Tin nhắn từ %s: Chúc mọi người online vui vẻ!";
    }
    
    
    public static String giftWin() {
        return "Bạn nhận được %s.";
    }
    ...
    public static String quaOffline() {
        return "Phần quà dành cho bạn sau 1 ngày offline là %s xu, %s lượng và %s XP";
    }
    
    public static String hopQuaBongDem1000() {
        return "Bạn đã may mắn mở được 1000 Tinh thể bóng đêm. Chúng tôi quyết định tặng thêm cho bạn %s xu và %s lượng";
    }
    
    public static String newsNoti() {
        return "Chào mừng %s đến với Mobi Army Ola - TNTGAME";
    }
    
            public static String newsBaoTri() {
        return "Bảo Trì: %s";
    }
        ...
        return "Thay thế nút nạp tiền thành lưu dữ liệu. Mọi người chơi xong nhớ ấn vào nút đó để lưu!";
    }
    ...
    public static String userLoginLock() {
        return "Tài khoản %s bị khóa vì hành vi: %s ";
    }
    
    public static String loginServerTest() {
        return "Máy chủ này chỉ dành cho admin hoặc người kiểm tra!";
    }

    public static String hopNgocSellError(){
        return "Số lượng không hợp lệ. Vui lòng chọn số lượng lớn hơn 0!";
    }    
    ...
    public static String ClanIsNull(){
        return "Chức năng hiện đang được phát triển bạn nhé! Quay lai sau.";
    }
    public static String hopNgocFail() {
        return "Chế ngọc thất bại, hao phí %d %s!.";
    }
    
     public static String hopKimCuongFail() {
        return "Ghép kim cương thất bại, hao phí %d %s!.";
    }
    ...
    public static String hopKimCuongSucess() {
        return "Ghép kim cương thành công hao phí %d %s thu được %d %s!.";
    }
    ...
    public static String hopKimCuongNC() {
        return "Bạn có muốn ghép kim cương? Tỉ lệ thành công là %s.";
    }
    ...
    public static String vanMayError() {
        return "Bạn không có đủ tiền. Bạn cần thêm %s xu và %s lượng!";
    }
    ...
    public static String resetTB() {
        return "Xoá trang bị thành công!";
    }
    ...
    public static String thaoNgocError1() {
        return "Không thể tháo ngọc, vui lòng mua item Tháo Ngọc Trang Bị";
    }
