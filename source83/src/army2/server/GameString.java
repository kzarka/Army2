...
public class GameString {
    ...
    public static String newsNoti() {
        return "Chào mừng %s đến với Mobi Army ";
    }
        ...
        return "Thay thế nút nạp tiền thành lưu dữ liệu. Mọi người chơi xong nhớ ấn vào nút đó để lưu data để nhận ngay 10 lượng!";
    }
    ...
    public static String userLoginLock() {
        return "Tài khoản %s bị khóa %s vì hành vi: %s ";
    }
    
    public static String userLoginActive() {
        return "Gửi tin nhắn: ON KHBERUS %s gửi 8585 để kích hoạt bạn nhé. ";
    }

    public static String userLoginPassCode() {
        return "Gửi tin nhắn: DV BMBERUS %s matkhau gửi 8585 để bảo mật tài khoản nhé. ";
    }    
